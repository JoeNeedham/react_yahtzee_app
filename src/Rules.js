...
class FullHouse extends Rule {
  evalRoll = dice => {
      ...
      return freqs.includes(2) && freqs.includes(3) ? this.scores : 0;
    };
  }
...
class SmallStraight extends Rule {
  evalRoll = (dice) => {
    ...
    // straight can be 234 + either 2 or 6
...
const smallStraight = new SmallStraight({ score: 30, description: '30 pints for a small' });
